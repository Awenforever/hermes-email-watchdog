        ...
        try:
            ...
            if lane.get("fast_lane"):
                ...
                semantic_meta = {
                    ...
                    "model": "hermes", "llm_called": False,
                    "decision_source": "fast_lane",
            ...
            if isinstance(semantic_meta, dict) and semantic_meta.get("decision"):
                semantic_meta["production_route_error"] = repr(exc)[:800]
                try:
                    semantic_meta["production_persist"] = email_semantic_engine.persist_production_observation(
                        email or {}, semantic_meta, production_route="legacy_fallback"
                    )
                except Exception:
                    pass
