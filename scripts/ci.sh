...
tests=(
  ...
  test_email_state_concurrency_recovery_matrix.py
  ...
  test_email_newton_spam_regression.py
  test_email_semantic_provenance_regression.py
  test_email_newton_real_e2e_grounding_regression.py
)
...
python3 tests/test_email_provenance_softwrap_regression.py
